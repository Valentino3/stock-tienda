  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // `max-h` + scroll: el diálogo está centrado con -translate-y-1/2, así
          // que uno más alto que la pantalla se sale por arriba Y por abajo, y
          // su botón de guardar queda inalcanzable — no hay nada que scrollear
          // porque la página de atrás está bloqueada. `dvh` y no `vh` por el
          // teclado en pantalla, mismo criterio que la lista del buscador.
